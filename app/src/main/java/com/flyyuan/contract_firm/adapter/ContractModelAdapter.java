...
public class ContractModelAdapter extends RecyclerView.Adapter<ContractModelAdapter.ViewHolder> {
    private List<ContractModelBean> modelBeanList ;
    private final Context context;

    public ContractModelAdapter(List<ContractModelBean> modelList,Context ActivityContext) {
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(parent.getContext(), ModelPDFActivity.class);
